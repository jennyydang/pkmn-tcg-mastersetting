  ...
  return (
    <>
      <div
        ...
        className={`relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow select-none ${isEditing ? "touch-none" : "touch-pan-y"}`}
      >
        {isEditing && (
          <button
